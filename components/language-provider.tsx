...
const translations = {
  en: {
    ...
    project_commercial_info: "Commercial product – Full version with access restrictions",
    project_in_dev_title: "Project in Development",
    project_in_dev_description: "Freelance Project & Billing Manager is in active development. Architecture and core modules are being designed and implemented. Demo version will be available after stabilization of core functions.",
    project_code_not_ready: "Source code will be published after completion of base architecture.",
    project_in_dev_close: "Close",
  ...
  de: {
    ...
    project_commercial_info: "Kommerzielles Produkt – Vollversion mit Zugangsbeschränkung",
    project_in_dev_title: "Projekt in Entwicklung",
    project_in_dev_description: "Freelance Project & Billing Manager befindet sich in aktiver Entwicklung. Architektur und Kernmodule werden entworfen und implementiert. Demo-Version wird nach Stabilisierung der Kernfunktionen verfügbar sein.",
    project_code_not_ready: "Quellcode wird nach Fertigstellung der Basisarchitektur veröffentlicht.",
    project_in_dev_close: "Schließen",
  ...
  ru: {
    ...
    project_commercial_info: "Коммерческий продукт – полная версия с ограничением доступа",
    project_in_dev_title: "Проект в разработке",
    project_in_dev_description: "Freelance Project & Billing Manager находится в активной разработке. Архитектура и ключевые модули проектируются и реализуются. Демонстрационная версия будет доступна после стабилизации core-функций.",
    project_code_not_ready: "Исходный код будет опубликован после завершения базовой архитектуры.",
    project_in_dev_close: "Закрыть",
